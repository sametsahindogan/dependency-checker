...
(function (h) {
    ...
    (function (f, h) {
        var p = f.defaultOptions, q = f.doc, B = f.Chart, r = f.addEvent, D = f.removeEvent, E = f.fireEvent,
            w = f.createElement, F = f.discardElement, y = f.css, n = f.merge, u = f.pick, G = f.objectEach,
            z = f.extend, K = f.isTouchDevice, A = f.win, I = A.navigator.userAgent, H = f.SVGRenderer,
            J = f.Renderer.prototype.symbols, L = /Edge\/|Trident\/|MSIE /.test(I), M = /firefox/i.test(I);
        z(p.lang, {
            printChart: "Yazdır"
        });
        ...
        z(B.prototype, {
            sanitizeSVG: function (b, a) {
                ...
                g || (e.exportContextMenu =
                    ...
                    if (f.isObject(a, !0)) {
                        var b;
                        a.separator ? b = w("hr", {className: "highcharts"}, null, n) : (b = w("div", {
            ...
            addButton: function (b) {
                var a = this, d = a.renderer, c = n(a.options.navigation.buttonOptions, b), f = c.onclick,
                    m = c.menuItems, k, e, h = c.symbolSize || 12;
