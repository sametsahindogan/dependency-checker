 ...
 */
class FetchNpm implements DependencyContract
{
    /** @var array $packages */
    protected $packages = [];
    ...
    /**
     * FetchNpm constructor.
     */
    public function __construct()
    {
        $this->type = DependencyModel::TYPE_NPM;
        $this->file = DependencyModel::FILE_NPM;
        $this->escapeChar = ['^', '-', '/', '*', '~'];
    }
    ...
    public function execute(GitResponse $response)
    {
        ...
        $content = $this->checkKey($response, 'dependencies');
     ...
     * @return bool|mixed
     */
    public function checkKey(GitResponse $response, $key)
    {
