<div class="modal-header">
    ...
    <h4 class="modal-title">Add E-Mail</h4>
</div>
<form id="form-email-add" method="POST" action="{{route('emails.create')}}">
    <div class="modal-body">
        <fieldset class="form-group title">
            <label class="form-label">E-Mail Address</label>
            <input type="email" class="form-control" name="title" autocomplete="off" placeholder="E-Mail Address">
        </fieldset>
...
<script>
    ...
    $("form#form-email-add").submit(function (e) {
    ...
    $(document).ready(function () {
        $("form#form-email-add input").on('keypress', function (e) {
